...
- Preferred: [GitHub private vulnerability reporting](https://github.com/ullbergm/nc-cdl-trainer/security/advisories/new)
...
- Content accuracy of the study questions (use the
  [question correction template](https://github.com/ullbergm/nc-cdl-trainer/issues/new?template=question-correction.yml)).
